...
export const rawEvents: Omit<CaseEvent, "relatedPersonIds" | "relatedEvidenceIds" | "relatedDocumentIds">[] = [
  ...
  },
  {
    ...
    "text": "Dne 13. 7. 2026 přišla výplatní páska za červen 2026 (TRAIVA s.r.o., zaměstnanec: já (zam14)). Tarif měsíční: 63 000 Kč. Fond pracovní doby: 22 dnů, 176 hodin. Odpracováno: 0 hodin. Zaměstnavatel klasifikoval 20 pracovních dnů (160 hodin) jako neomluvené absence — přičemž správná klasifikace měla být překážky v práci na straně zaměstnavatele (§ 208 ZP). Dovolená: 2 dny (16 hodin). Vyplaceno: 7 322 Kč hrubého, čistá mzda 4 236 Kč. Průměrný výdělek pro náhrady: 457,63 Kč/hodinu. Při správné klasifikaci (§ 208 ZP) by náhrada za 160 hodin činila 73 221 Kč hrubého. Zaměstnavatel neodvedl povinné pojistné — zdravotní pojištění a ČSSZ — v plné výši. Tuto skutečnost jsem bezodkladně doplnila do podnětu na Oblastní inspektorát práce (OIP). K dnešnímu dni (14. 7. 2026) jsem neobdržela žádnou výpověď ani jiné formální rozvázání pracovního poměru — pracovní poměr tedy formálně stále trvá.",
    "legal": "Klasifikace 20 dnů jako neomluvená absence je fakticky nesprávná: byla jsem připravena a ochotna pracovat (doloženo formálními výzvami z 11. 6. a 16. 6. 2026), ale zaměstnavatel odebral veškeré pracovní přístupy — čímž sám vytvořil překážku (§ 208 ZP). Správná klasifikace: překážky na straně zaměstnavatele, nárok: průměrný výdělek (457,63 Kč/h × 160 h = 73 221 Kč hrubého). Neodvedení pojistného v zákonné výši je dalším porušením — doplněno do OIP podnětu. Absence výpovědi ke dni 14. 7. 2026 má dvojí právní význam: (1) pracovní poměr trvá, nárok na mzdu/náhradu narůstá každý den; (2) zaměstnavatel dosud nepostupoval formálně — možná vyčkává nebo připravuje jiný postup. Klasifikace jako neomluvená absence je nebezpečná: dává podklad pro výpověď (§ 52 písm. g ZP) nebo okamžité zrušení (§ 55 odst. 1 písm. b ZP) — považuji to za účelové vytváření důvodů k rozvázání. Chci probrat: (1) jak formálně a bez zbytečného odkladu zpochybnit klasifikaci; (2) zda narůstající dluh na mzdě (§ 208 ZP) zvyšuje moji vyjednávací pozici; (3) jak se bránit případné výpovědi opírající se o neomluvené absence.",
    "tags": [
      "pracovněprávní",
      "mzda"
    ],
  ...
  },
  {
    ...
    "legal": "Klíčový exkulpační důkaz: Ing. Ospalík v DD (due diligence) komunikaci z jara 2026 sám vysvětlil: 'pokles v roce 2025 vysvětlen spuštěním ERP v lednu 2025 a vědomým tlumením reklamy cca 6–9 měsíců'. Tato skutečnost vylučuje, aby jakékoli hodnocení mého výkonu v 1. pololetí 2025 vycházelo pouze z poklesu marketingových výsledků. Pro advokáta: přímé vyvracení případných tvrzení zaměstnavatele o neuspokojivém výkonu v tomto období.",
    "tags": [
      "pracovněprávní",
      "obchodní",
      "Odoo"
  ...
  },
  {
    ...
    "text": "V říjnu 2025 jsem přijala Karin Švédovou jako dočasnou posilu expedice v důsledku výpadku personálu (dlouhodobé PN a dovolené zaměstnankyň expedice). Nábor jsem zajistila jako provozní opatření; v plánu bylo Karin přesunout na prodejnu místo Dany Rogalové bez navýšení stavu. Ing. Ospalík byl s plánem obeznámen a sám zmrazil organizační změny kvůli probíhající akvizici. Karin nikdy nevykonávala marketingové úkoly.",
    "legal": "Můj e-mail → Jiří Premus (30. 4. 2026, předmět 'Stav pracovníků a náklady') prokazuje: (1) Karin přijata jako zástup na expedici v období PN, (2) koordinovala jsem svůj postup s vedením, (3) Ospalík zmrazil změny kvůli akvizici — proto nebyla Karin přesunuta dle plánu. Teams chat s Barborou Slonkovou (říjen 2025) dokládá provozní kontext přijetí. Závěr: jakékoli tvrzení zaměstnavatele, že Karin byla přijata jako marketingová specialistka nebo bez vědomí vedení, je interními zdroji vyvráceno.",
    "tags": [
      "pracovněprávní",
      "obchodní"
    ],
...
,
  {
    ...
    "text": "Karin Švédová, kterou jsem přijala a která byla přeřazena na uklízečku po odmítnutí výpovědi 10. 6., a od 11. 6. byla na PN pro psychické obtíže, podala 17. 7. 2026 formální podnět k Oblastnímu inspektorátu práce pro Moravskoslezský kraj a Olomoucký kraj. Podání potvrzeno SÚIP (ID f83b0ad4-7041-4a79-924a-643cd19a6948, číslo podání 20260001). Podnět z NEZÁVISLÉHO zdroje a ÚŘEDNÍ evidence potvrzuje: veřejnou pomluvu vůči mně ('neoprávněný výběr 100 000 Kč') na ranní poradě 10. 6. 2026 před všemi zaměstnanci, plošný zákaz kontaktu zaměstnanců se mnou, a mé označení jako 'přímé nadřízené'. Karin zároveň upozorňuje na systémový vzorec: DPP jako obcházení zákonného odměňování, výtky vydávané retroaktivně v den eskalace, přeřazování bez písemného dodatku.",
    "legal": "Podnět k OIP je VEŘEJNÝ DOKUMENT s úřední evidencí — nelze ho zpochybnit jako soukromé sdělení. Potvrzuje pomluvu (§ 184 TZ, § 82 OZ) z nezávislého zdroje: Karin nebyla nikdy účastnicí pracovněprávního sporu se mnou, nemá zájem na výsledku mého sporu. Svědkyně jmenovány v OIP podnětu: Natalie Baloghová, Nikol Kostková, Šárka Mullerová, Kateřina Hájková. Inspektorát práce nyní má povinnost kontrolu provést — výsledek kontroly bude dalším důkazem v mé věci.",
    "tags": [
      "pracovněprávní",
      "OIP"
    ],
