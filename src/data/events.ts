...
export const rawEvents: Omit<CaseEvent, "relatedPersonIds" | "relatedEvidenceIds" | "relatedDocumentIds">[] = [
  ...
  },
  {
    ...
    "date": "16. 6. 2026",
    "year": "2026",
    "title": "Formální výzva 2 + podnět OIP — eskalace bez odpovědi (16. 6. 2026)",
    "text": "Dne 16. 6. 2026, po uplynutí lhůty 5 pracovních dnů bez jakékoli odpovědi zaměstnavatele, jsem učinila dva kroky. Za prvé: podala jsem podnět k Oblastnímu inspektorátu práce (OIP). Za druhé: zaslala jsem Ospalíkovi formální výzvu 2 — „eskalaci žádosti ze dne 11. 6. 2026 na úroveň právně závazného požadavku\" — současně třemi kanály: datovou schránkou, e-mailem a doporučenou poštou. Výzva obsahovala konkrétní lhůty: do 20. 6. 2026 obnovení přístupů nebo export podkladů (urgentní) a obnovení home office; do 30. 6. 2026 vyúčtování mzdy za 36 měsíců a písemné zdůvodnění snížení bonusové složky; ihned zahájení písemné komunikace. Nově přidaný požadavek: doložení auditních logů (GDPR čl. 15 + § 96 ZP) a doložení rovného zacházení se srovnatelnými zaměstnanci (§ 16 ZP). Výzva varovala, že pokud bylo snížení bonusu reakcí na uplatnění zákonných práv, jde o odvetné opatření (§ 346b odst. 4 ZP). Odpověď ani plnění nepřišlo ani na tuto výzvu.",
