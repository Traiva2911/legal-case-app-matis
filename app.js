...
const evidence = [
  ...
  { id: "e-paska-2026", title: "Výplatní pásky 2-5/2026 — prémie 0 a pokles průměru", type: "Mzdové dokumenty", date: "2-5/2026", strength: 5, proves: ["prémie 0 Kč (z dřívějších 47-62 tis. měsíčně)", "průměr pro náhrady klesl na 457,63 Kč/h (z 549,18)", "květen 2026: měsíc krytý převážně náhradami (dovolená + placené volno, 43 932 Kč) — řádek překážek zaměstnavatel nevykazuje, přestože mi odebral přístupy"], risk: "Zajištěno na Drive (7 pásek 2-5/2026). Dovolená mi byla NAŘÍZENA 12. 5. 2026 — v den odvolání, ze dne na den, bez předchozího upozornění na termín; nařízení jsem podepsala, ale vlastní kopii mi nepředali. Rozhodnutí o odvolání jsem naopak odmítla podepsat. Zeptat se advokáta: smí se dovolená nařizovat takto, a smí firma dobu bez přístupů vykazovat jako mou dovolenou místo překážek na své straně?", tags: ["mzda", "pracovněprávní"], people: ["Andrea Matis"], file: "https://drive.google.com/drive/folders/10cYncs-DqJjerMVHXjwAdaNLvDQOKl4V" },
...
const documents = [
  ...
  { id: "d-usneseni", title: "Notářský zápis — jmenování jednatelkou", type: "rozhodnutí jediného společníka (sken)", date: "24. 6. 2024", tags: ["jednatel"], file: "https://drive.google.com/file/d/1eCAa25alrAYcvMjsaBmiR_GSXIW1OhTj/view" },  { id: "d-payroll", title: "Výplatní pásky 04/2025 (3×) + 02–05/2026 (7×)", type: "mzdová příloha — vývoj prémií před a po e-mailu z 11. 3. 2026", date: "2025-2026", tags: ["mzda", "DPP"], file: "https://drive.google.com/drive/folders/10cYncs-DqJjerMVHXjwAdaNLvDQOKl4V" },
